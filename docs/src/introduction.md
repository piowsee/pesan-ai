...
This guide follows the journey most clients take: request consultation, receive account access, connect WhatsApp Business, then use the dashboard to monitor conversations and customer contacts.
...
- Sign in to an assigned account after your access is created by the pesan.ai team.
...
- Review customer contacts from connected WhatsApp accounts.
- Export customer contact data for follow-up, reporting, or operational review.
...
3. Wait for account creation after agreement and payment.
4. Sign in to the dashboard.
5. Connect WhatsApp Business.
6. Review dashboard activity.
7. Use Chat and Customers features.
8. Export customer contacts when needed.
