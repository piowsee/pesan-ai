...
## I selected the wrong business portfolio

If the Meta popup still allows changes, go back and choose the correct business portfolio.

If not, close the popup and restart the onboarding process from **WABA Management**. Choose the business portfolio that owns or manages the WhatsApp Business account you want to connect.

---

## I did not receive a Facebook Business message in WhatsApp

Check that:

- You entered the correct WhatsApp Business phone number.
- The phone has an active internet connection.
- You can open the WhatsApp Business App.
- You are checking the correct WhatsApp account.
...
## Connected account shows Suspended or needs attention

Open WABA Management and review the account status.
...
This can happen if no customer has chatted with the connected WhatsApp account yet, the selected WABA or number filter has no contacts, or the WhatsApp Business Account is not connected correctly.

Click **Clear** to remove filters, then check **WABA Management** to confirm the account status.

---

## Export Excel does not download

Try the following:

- Check whether filters are active.
- Confirm there are customer rows to export.
