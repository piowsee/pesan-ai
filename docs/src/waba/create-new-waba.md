...
- Access to the Facebook account that manages your business assets.
- Business information required by Meta.
- The WhatsApp phone number you want to use.
- Access to receive verification if Meta requires it.
...
3. **Continue in Meta onboarding.** Follow the instructions shown by Meta.

4. **Select or create a business portfolio.** Choose an existing business portfolio or create a new one if required.

5. **Create a new WhatsApp Business Account.** Choose the option to create a new WhatsApp Business Account.
