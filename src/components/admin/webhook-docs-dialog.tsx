      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="flex flex-col gap-5 text-sm">
          ...
          <div className="flex flex-col gap-2 border-t pt-4">
            ...
            <p className="text-muted-foreground">
              When you register a webhook, pesan-ai sends a <strong>GET</strong>{' '}
              request to your URL to verify it is reachable and can
              authenticate. Your endpoint must validate the JWT token and return
              a{' '}
              <code className="rounded bg-muted px-1 py-0.5 text-xs font-mono">
                200 OK
              </code>{' '}
...
Expected Response: 200 OK`}
          ...
          <div className="flex flex-col gap-2 border-t pt-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-foreground">Message Request</h3>
            </div>
            <p className="text-muted-foreground">
              When a new message is received, pesan-ai forwards it to your
              webhook via a <strong>POST</strong> request. Your endpoint should
              validate the JWT token, process the message, and return a
              response.
            </p>
