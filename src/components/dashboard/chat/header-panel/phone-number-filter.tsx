    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          type="button"
          disabled={disabled}
          className="flex h-7 max-w-36 cursor-pointer items-center gap-1.5 px-0 text-left text-foreground/60 hover:bg-transparent hover:text-brand focus-visible:text-brand data-[state=open]:text-brand disabled:text-muted-foreground"
        >
